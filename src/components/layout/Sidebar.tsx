import { MessageSquare, LayoutDashboard, Settings, Users, Bot, LogOut } from 'lucide-react';
import { useLocation, Link } from 'react-router-dom';
import { Tooltip, TooltipContent, TooltipTrigger } from '@/components/ui/tooltip';

const navItems = [
  { icon: MessageSquare, label: 'المحادثات', path: '/' },
  ...
  return (
    <div className="w-[72px] h-screen bg-card border-r border-border flex flex-col items-center py-4 flex-shrink-0">
      ...
      <div className="flex flex-col gap-1">
        ...
        <Tooltip delayDuration={0}>
          <TooltipTrigger asChild>
            <button className="w-11 h-11 rounded-xl flex items-center justify-center text-muted-foreground hover:text-destructive hover:bg-secondary transition-all duration-200">
